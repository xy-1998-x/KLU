...
int main()
{
    ...
    for (int i = 0; i < Symbolic->n; i++) {
        printf("%d ", Symbolic->P[i]);
    }
    printf("]\n");
    printf("Q: [");
    for (int i = 0; i < Symbolic->n; i++) {
        printf("%d ", Symbolic->Q[i]);
    }
    printf("]\n");
    printf("R: [");
    for (int i = 0; i <= Symbolic->nblocks; i++) {
        printf("%d ", Symbolic->R[i]);
    }
    printf("]\n");
    printf("nzoff: %d\n", Symbolic->nzoff);
    printf("nblocks: %d\n", Symbolic->nblocks);
    ...
    for (int i = 0; i < Numeric->n; i++) {
        printf("%d ", Numeric->Pnum[i]);
    }
    printf("]\n");
    printf("Pinv: [");
    for (int i = 0; i < Numeric->n; i++) {
        printf("%d ", Numeric->Pinv[i]);
    }
    printf("]\n");
    printf("Lip: [");
    for (int i = 0; i < Numeric->n; i++) {
        printf("%d ", Numeric->Lip[i]);
    }
    printf("]\n");
    printf("Uip: [");
    for (int i = 0; i < Numeric->n; i++) {
        printf("%d ", Numeric->Uip[i]);
    }
    printf("]\n");
    printf("Llen: [");
    for (int i = 0; i < Numeric->n; i++) {
        printf("%d ", Numeric->Llen[i]);
    }
    printf("]\n");
    printf("Ulen: [");
    for (int i = 0; i < Numeric->n; i++) {
        printf("%d ", Numeric->Ulen[i]);
    }
    printf("]\n");
    printf("LUbx: [");
    for (int i = 0; i < Numeric->nblocks; i++) {
        printf("%p ", Numeric->LUbx[i]);
    }
    printf("]\n");
    printf("LUsize: [");
      for (int i = 0; i < Numeric->nblocks; i++) {
        printf("%zu ", Numeric->LUsize[i]);
    }
    printf("]\n");
    printf("Udiag: %p\n", Numeric->Udiag);
    printf("Rs: [");
    for (int i = 0; i < Numeric->n; i++) {
        printf("%f ", Numeric->Rs[i]);
    }
    printf("]\n");
    printf("worksize: %zu\n", Numeric->worksize);
    printf("Work: %p\n", Numeric->Work);
    ...
    printf("Iwork: [");
    for (int i = 0; i < Numeric->n; i++) {
        printf("%d ", Numeric->Iwork[i]);
    }
    printf("]\n");
    printf("Offp: [");
    for (int i = 0; i <= Numeric->n; i++) {
        printf("%d ", Numeric->Offp[i]);
    }
    printf("]\n");
    printf("Offi: [");
    for (int i = 0; i < Numeric->nzoff; i++) {
        printf("%d ", Numeric->Offi[i]);
    }
    printf("]\n");
    printf("Offx: %p\n",Numeric->Offx);
    printf("nzoff: %d\n", Numeric->nzoff);
